...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-950 shadow-lg fixed w-full py-3 z-50 bg-opacity-75">
      <div className="max-w-7xl mx-auto px-4 backdrop-blur-sm">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/about" className="text-gray-400 hover:text-gray-500 px-3 py-2 rounded-md transition duration-150">
              About
            </Link>
            <Link 
              to="/signup" 
              className="bg-gray-900 text-white px-4 py-2 rounded-md hover:bg-gray-900 transition duration-150"
            >
              Sign Up
            </Link>
          </div>
          ...
          <div className="md:hidden flex items-center">
            <button 
              ...
              className="text-gray-600 hover:text-gray-300 focus:outline-none p-2 rounded-md"
      ...
      <div 
        className={`fixed top-0 right-0 h-full w-64 bg-gray-950 transform transition-transform duration-300 ease-in-out md:hidden ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-col px-4 py-2 space-y-2">
            ...
            {/* <Link 
              to="/profile" 
              className="text-gray-600 hover:text-gray-900 hover:bg-gray-100 px-3 py-2 rounded-md transition duration-150"
            >
              Profile
            </Link> */}
            <Link 
            ...
            <Link 
              to="/signup" 
              className="bg-gray-600 text-white px-4 py-2 rounded-md transition duration-150 text-center"
            >
              Sign Up
            </Link>
          </div>
